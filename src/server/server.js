    ...
    app.get('/api/status', (req, res) => {
      res.json({
        ...
        config: {
          ...
          rsi15sPeriod: config.activityFlow.rsi15sPeriod,
          rsi15sEntryThreshold: config.activityFlow.rsi15sEntryThreshold,
          rsi15sVolumeWindowMs: config.activityFlow.rsi15sVolumeWindowMs,
          rsi15sMinVolume60sUsd: config.activityFlow.rsi15sMinVolume60sUsd,
          pullbackShadowOnly: config.activityFlow.pullbackShadowOnly,
          pullbackVolume10mMinUsd: config.activityFlow.pullbackMinVolumeUsd,
          pullbackVolume10mMaxUsd: config.activityFlow.pullbackMaxVolumeUsd,
